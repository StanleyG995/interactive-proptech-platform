...
const ApartmentsList = () => {
    return (
        <table className="w-full max-w-[1300px] m-auto border-collapse border border-gray-200 text-zinc-800 text-center ">
            <thead>
                <tr className="bg-gray-200 text-zinc-800 font-bold">
                    ...
                    <th className="border border-gray-300 p-2">Balcony Area (m²)</th>
